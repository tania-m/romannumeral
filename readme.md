...
- **api-documentation**: contains the swagger file describing the API. Also contains an API documentation in HTML that was automatically generated by swagger-editor using the swagger file of the project. That documentation is not made available through the API server when the server is running, it is mostly for development/testing/deployment usage. HTML files were generated for better readability and convenience.
- **code-documentation**: contains HTML version of the code documentation for the romanNumberHandlers. Subfolder romannumeral-route-code-doc contains documentation for code of the romannumeral route. That documentation is not made available through the API server when the server is running, it is mostly for development/testing/deployment usage. HTML files were generated for better readability and convenience.
